...
from Data.data_aug import data_aug_blur, data_aug_color, data_aug_noise, data_aug_light
from Data.data_aug import data_aug_flip, flip_data, aug_matrix
from Data.data_aug import show_edge, mask_to_bbox, load_json
from Data.data_aug import padding, Normalize_Img
from Data.data_aug import data_motion_blur, data_Affine, data_Perspective, data_ThinPlateSpline
from Data.data_aug import data_motion_blur_prior, data_Affine_prior, data_Perspective_prior, data_ThinPlateSpline_prior

class PortraitSeg(Dataset): 
    def __init__(self, ImageRoot, AnnoRoot, ImgIds_Train, ImgIds_Test, exp_args):
        super(PortraitSeg,self).__init__(ImageRoot, AnnoRoot, ImgIds_Train, ImgIds_Test, exp_args)
        ...
        self.total_len = len(self.imgIds)
        self.set_attrs(total_len = self.total_len,shuffle=self.shuffle)
